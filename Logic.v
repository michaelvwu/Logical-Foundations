...
Proof.
  intros n m H. induction n. split.
    reflexivity. simpl in H. trivial.
...
Proof.
  ...
  unfold not in HQnot. 
  intros P'. 
  apply HQnot. apply H. apply P'. Qed.
(** [] *)
...
Proof.
  ...
  - (* <- *) intros R'. apply HRQ in R'. apply HQP in R'. apply R'. Qed.
(** [] *)
...
Proof. 
  ...
  unfold not in HPnot. apply HPnot. apply Hall. Qed.
(** [] *)
...
Proof.
  ...
  - (* <- *) intros H. destruct H as [HP | HQ].
    ...
    + destruct HQ as [X' HQ]. exists X'. right. apply HQ. Qed.
(** [] *)
...
Proof.
  ...
  rewrite Hodd in Hcomb. assumption. Qed.
...
Proof.
  ...
  unfold combine_odd_even in Hcomb.
  rewrite Heven in Hcomb. assumption. Qed.
(** [] *)
