...
Inductive bin : Type :=
  | Zero : bin
  | Double : bin -> bin
  | DoublePlusOne : bin -> bin.


Fixpoint inc_bin (b : bin) : bin :=
  match b with
  | Zero => DoublePlusOne Zero
  | Double b' => DoublePlusOne b'
  | DoublePlusOne b' => Double (inc_bin b')
  end.
...
Fixpoint bin_to_nat (b : bin) : nat :=
  ...
  | DoublePlusOne b' => S (mult 2 (bin_to_nat b'))
  end.
...
Example inc_three_four: (bin_to_nat (inc_bin (DoublePlusOne (DoublePlusOne Zero)))) = 4.
Proof. reflexivity. Qed.

Example inc_nine_ten: (bin_to_nat (inc_bin (DoublePlusOne (Double (Double (DoublePlusOne Zero)))))) = 10.
Proof. reflexivity. Qed.

Example five_is_five: (bin_to_nat (DoublePlusOne (Double (DoublePlusOne Zero)))) = 5.
Proof. reflexivity. Qed.
