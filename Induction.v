...
(* Destruct uses more general information to solve to a specific conclusion
whereas induction uses individual arguments to develop a specific generalization.*)
*)
(** [] *)
...
Theorem mult_dist : forall n m : nat, n * S m = n + n * m.
Proof.
  intros n m.
  induction n as [|n'].
  (*Case "n = 0".*)
...
Fixpoint bin_to_nat (b : bin) : nat :=
  ...
  | TwicePlus b' => S (mult 2 (bin_to_nat b'))
  end.
